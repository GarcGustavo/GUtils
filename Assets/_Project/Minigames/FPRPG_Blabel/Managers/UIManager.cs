...
public class UIManager : MonoBehaviour
{
	...
	private void Start()
	{
		...
		_events.enemyTurn.AddListener(UpdateTurnCounter);
		_events.newTurn.AddListener(UpdateHealth);
		_events.newTurn.AddListener(UpdateMana);
		_events.newTurn.AddListener(UpdateAP);
		_events.playerDeath.AddListener(GameOverScreen);
	}
